# Research fingerprint icons

These five small SVGs were drawn specifically for this profile so the research fingerprint uses one canvas size, stroke system, corner radius, and visual weight.

| File | Meaning |
|---|---|
| `protein-backbone.svg` | Structural bioinformatics and protein interfaces |
